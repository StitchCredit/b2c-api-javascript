...
var _TrendedDataYearReport = _interopRequireDefault(require("./TrendedDataYearReport"));
 ...
 * @version 1.0.0
 */
var TrendedDataReport = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TrendedDataReport</code>.
   * @alias module:model/TrendedDataReport
   */
  function TrendedDataReport() {
    _classCallCheck(this, TrendedDataReport);
  ...
  _createClass(TrendedDataReport, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('years')) {
          obj['years'] = _ApiClient["default"].convertToType(data['years'], [_TrendedDataYearReport["default"]]);
        }
...
var _default = TrendedDataReport;
