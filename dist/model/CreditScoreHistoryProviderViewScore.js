 ...
 * @version 1.0.0
 */
var CreditScoreHistoryProviderViewScore = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreditScoreHistoryProviderViewScore</code>.
   * @alias module:model/CreditScoreHistoryProviderViewScore
   */
  function CreditScoreHistoryProviderViewScore() {
    _classCallCheck(this, CreditScoreHistoryProviderViewScore);
  ...
  _createClass(CreditScoreHistoryProviderViewScore, null, [{
    key: "initialize",
  ...
  return CreditScoreHistoryProviderViewScore;
}();
/**
 * @member {Number} score
 */
...
var _default = CreditScoreHistoryProviderViewScore;
